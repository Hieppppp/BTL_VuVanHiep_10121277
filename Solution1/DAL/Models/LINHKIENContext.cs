...
{
    public partial class LINHKIENContext : DbContext
    {
        public LINHKIENContext()
        {
        }

        public LINHKIENContext(DbContextOptions<LINHKIENContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HangSanXuat>(entity =>
            {
                entity.HasKey(e => e.MaHang)
                    .HasName("PK__HangSanX__19C0DB1D7C847C88");
            ...
            {
                entity.HasKey(e => e.MaHoaDon)
                    .HasName("PK__HoaDonNh__835ED13B7B171BC6");
            ...
            modelBuilder.Entity<NhaPhanPhoi>(entity =>
            {
                entity.HasKey(e => e.MaNhaPhanPhoi)
                    .HasName("PK__NhaPhanP__794D66631A1DEEA4");
                ...
                entity.HasMany(d => d.MaSanPhams)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MaNhaPhanPhoi", "MaSanPham").HasName("PK__SanPhams__B6E1122178F46F1F");
            ...
            modelBuilder.Entity<Slide>(entity =>
            {
                entity.HasKey(e => e.MaAnh)
                    .HasName("PK__Slide__356240DF52C78705");
